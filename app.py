...
def add_user_to_g():
    ...
    if CURR_USER_KEY in session: ## if there is a user in the session (aka they are logged in)
        g.user = User.query.get(session[CURR_USER_KEY]) ## we are assigning .user to the "g" global variable
...
def show_likes(user_id):
    """Show liked warbles for this user."""
